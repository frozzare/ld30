...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(326)
		int _g7 = ::openfl::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(326)
		int _g8 = ::openfl::Lib_obj::get_current()->get_stage()->get_stageHeight();		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(326)
